...
import { jsonAPIMapper } from '@tdm/json-api-mapper';
  ...
  describe('DESERIALIZE', () => {
    ...
    it('should deserialize a basic document', () => {
      ...
      const res = targetStore.deserialize(
        jsonAPIMapper.deserializer(basic.payload, Article)
      );
    ...
    it('should deserialize a basic collection document', () => {
      ...
      const resArr: any[] = targetStore.deserialize(
        jsonAPIMapper.deserializer(basicColl.payload, Article)
      ) as any;
    ...
    it('should deserialize an included resources', () => {
      ...
      commentModifier
        .setModel({ resName: 'comments' })
        .setIdentity('id')
        .props('id', 'body');

      const res: Article = targetStore.deserialize(
        jsonAPIMapper.deserializer(included.payload, Article)
      ) as any;
  ...
  describe('SERIALIZE', () => {
    ...
    it('should serialize a basic document', () => {
      ...
      const ser = targetStore.serialize(
        Article,
        jsonAPIMapper.serializer(resource)
      );
    ...
    it('should serialize a basic collection document', () => {
      ...
      const ser = targetStore.serialize(
        Article,
        jsonAPIMapper.serializer(resources)
      );
    ...
    it('should serialize an included resources', () => {
      ...
      ser.data.relationships.freestyle =
        included.payload.data.relationships.freestyle;
