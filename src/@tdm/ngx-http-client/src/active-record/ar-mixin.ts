...
export function ActiveRecord<Model, TypeofModel>(): Type<Model & TDMModel<Model> & HttpActiveRecord> & TypeofModel & HttpActiveRecordStatic<Model> & typeof HttpActiveRecord;
export function ActiveRecord<Model, TypeofModel>(model: TypeofModel & Type<Model>): Type<Model & TDMModel<Model> & HttpActiveRecord> & TypeofModel & HttpActiveRecordStatic<Model> & typeof HttpActiveRecord;
export function ActiveRecord<Model, TypeofModel, T1, C1>(model: TypeofModel & Type<Model>, m1: C1 & Type<T1>): Type<Model & HttpActiveRecord & T1> & TypeofModel & typeof HttpActiveRecord &  HttpActiveRecordStatic<Model> & C1;
export function ActiveRecord<Model, TypeofModel, T1, C1, T2, C2>(model: TypeofModel & Type<Model>, m1: C1 & Type<T1>, m2: C2 & Type<T2>): Type<Model & TDMModel<Model> & HttpActiveRecord & T1 & T2> & TypeofModel & typeof HttpActiveRecord &  HttpActiveRecordStatic<Model> & C1 & C2;
export function ActiveRecord<Model, TypeofModel, T1, C1, T2, C2, T3, C3>(model: TypeofModel & Type<Model>, m1: C1 & Type<T1>, m2: C2 & Type<T2>, m3: C3 & Type<T3>): Type<Model & TDMModel<Model> & HttpActiveRecord & T1 & T2 & T3> & TypeofModel & typeof HttpActiveRecord &  HttpActiveRecordStatic<Model> & C1 & C2 & C3;
export function ActiveRecord<Model, TypeofModel, T1, C1, T2, C2, T3, C3, T4, C4>(model: TypeofModel & Type<Model>, m1: C1 & Type<T1>, m2: C2 & Type<T2>, m3: C3 & Type<T3>, m4: C4 & Type<T4>): Type<Model & TDMModel<Model> & HttpActiveRecord & T1 & T2 & T3 & T4> & TypeofModel & typeof HttpActiveRecord &  HttpActiveRecordStatic<Model> & C1 & C2 & C3 & C4;
...
export function ActiveRecord<Model, TypeofModel, TMIXIN, CMIXIN>(model?: TypeofModel & Type<Model>, ...mixins: Array<CMIXIN & Type<TMIXIN>>): Type<Model & TDMModel<Model> & HttpActiveRecord & TMIXIN> & HttpActiveRecordStatic<Model> & TypeofModel & typeof HttpActiveRecord & CMIXIN  {
 ...
 */
export type TypeOfActiveRecord<Model, TypeofModel> = Constructor<ActiveRecord<Model>> & TypeofModel & HttpActiveRecordStatic<Model> & typeof HttpActiveRecord;
