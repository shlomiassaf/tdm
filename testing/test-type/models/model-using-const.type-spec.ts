...
new UserConst().$get().parent.username;
 ...
 * @tssert
 * @tsType Promise<ResourceControl<TDMModel<ActiveRecord<$User>> & $User & TDMModel<$User> & HttpActiveRecor...
 * @loc 16
 */
...
new UserConstExt().$get().parent.username;
 ...
 * Keep type information in promise chain - active record method
 * @tssert
 * @tsType Promise<ResourceControl<TDMModel<UserConstExt & $User> & UserConstExt & $User>>
 * @loc 19
 */
